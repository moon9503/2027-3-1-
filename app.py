...
def download_excel():
    ...
    ws_raw.column_dimensions["C"].width = 35
    ws_raw.column_dimensions["D"].width = 12
    ws_raw.column_dimensions["E"].width = 35
    ws_raw.column_dimensions["F"].width = 12
    ws_raw.column_dimensions["G"].width = 35
    ws_raw.column_dimensions["H"].width = 12
    ws_raw.column_dimensions["I"].width = 35
    ws_raw.column_dimensions["J"].width = 12
    ws_raw.column_dimensions["K"].width = 20
